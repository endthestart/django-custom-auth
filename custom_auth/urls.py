...
urlpatterns = patterns('',
                       url(r'^login/$', auser_views.login, {'template_name': 'custom_auth/login.html'},
                           name='auth_login'),
                       ...
                       url(r'^register/$', auser_views.register, {'template_name': 'custom_auth/register.html'},
                           name="auth_register"),
                       url(r'^register/successful/$', auser_views.registration_successful,
                           {"template_name": "custom_auth/registration_successful.html"},
